...
export const PublicPage: React.FC<PublicPageProps> = ({ onLoginClick }) => {
    return (
        <div className="text-center mt-20 space-y-6 flex flex-col justify-center">
            ...
            <Button
                ...
                icon={<Star size={18} />}
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#c2a774] to-[#e5d9a5] text-[#223120] hover:from-[#e5d9a5] hover:to-[#fffbe6] shadow-md font-lora text-lg transition border border-[#c2a774]"
            >
                Войти в мир магии
            </Button>
        </div>
